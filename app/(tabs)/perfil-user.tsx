...
export default function PerfilScreen() {
  ...
  const handleLogout = () => {
    Alert.alert(
      "Sair da Conta",
      "Dalvan, tens a certeza que desejas sair do Gasolink?",
      [
        ...
        { 
          ...
          style: "destructive", 
          onPress: () => {
            // Se o seu objetivo é voltar para a tela inicial dentro das tabs:
            if (router.canGoBack()) {
...
const styles = StyleSheet.create({
  ...
  verifiedBadge: { 
    ...
    borderRadius: 15, width: 28, height: 28, justifyContent: "center", alignItems: "center",
  ...
  badgePremium: { 
    ...
    paddingHorizontal: 16, paddingVertical: 8, borderRadius: 25, marginTop: 15, elevation: 4
  },
  ...
  statBox: { 
    width: "31%", backgroundColor: "#fff", paddingVertical: 20, borderRadius: 24, 
    alignItems: "center", elevation: 2, shadowColor: "#000", shadowOpacity: 0.05, shadowRadius: 10
  },
  ...
  menuContainer: { 
    marginTop: 20, backgroundColor: "#fff", borderRadius: 28, padding: 20,
  ...
  logoutBtn: { 
    ...
    backgroundColor: "#fef2f2", borderRadius: 15, paddingHorizontal: 15
  },
  logoutIconBg: {
    width: 36, height: 36, backgroundColor: "#fee2e2", borderRadius: 10,
